...
while ($query->fetch()):
    ...
    <?php echo substr($content, 0, $lastspace) . "<br><a href='view_post.php?post_id=$post_id' class='btn btn-primary' class='btn btn-primary'> READ MORE...</a>" ?>
                    </div>
                    <div class="card-footer text-muted">
                        Posted on <?php echo $date ?> by
                        <a href="<?php echo 'view_profile.php?name='.$name?>"  ><?php echo $name ?></a>  <img src='uploads/<?php echo$avatar ?>' style='margin-right: 0%; height:24px;width: 24px;'>
                    </div>
                </div>
<?php endwhile ?>
...
<?php
if ($prev > 0) {
    echo "<a href='index.php?p=$prev'Prev class='btn btn-primary'>Prev</a>&nbsp;&nbsp;&nbsp&nbsp;&nbsp;";
}
if ($page < $pages) {
    echo "<a href='index.php?p=$next' class='btn btn-primary'>Next</a>";
}
?>
            <!-- Blog Post -->
            <!--          <div class="card mb-4">
        ...
        <script src="readCountry.js" type="text/javascript"></script>
        <div class="col-md-4">
<script></script>
            <!-- Search Widget -->
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Search for..."  name='search'  id="search-box">
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <ul  style="    margin-right: -129px;list-style-type: none;">
                    ...
                    while ($row = mysqli_fetch_array($result))
                    {
                        ?>  
                                <li>
                                    <a href="view_post.php?post_id=<?php echo $row["post_id"]; ?>"><?php echo $row["post_title"]; ?></a>
                                </li>
                                <?php
}
?>  
